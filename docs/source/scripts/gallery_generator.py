...
gallery_path = os.path.join(os.path.dirname(__file__), '..', 'pages', 'gallery.rst')
...
def generate_rst():
    ...
    plots = os.listdir(os.path.join(os.path.dirname(__file__), '..', 'plots'))
    plots.sort()
...
def generate_html():
    ...
    path_figs = os.path.join(os.path.dirname(__file__), '..', 'plots')
    ...
    ################################################################################################
    # Generate HTML plots and save them in the docs/source/plots folder
    ################################################################################################
